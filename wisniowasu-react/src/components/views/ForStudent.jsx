...
import { ForStudentServiceCardComponent } from "../layouts/ForStudentComponent/ForStudentServiceCardComponent/ForStudentServiceCardComponent";

const ForStudent = () => {
    return(<ForStudentComponent
